...
$(function(){
  ...
  $("#CreatNewSu").click(function(){
      if($("#CreatNewDes").val()=="|文字描述"||$("#CreatNewDes").val()=="描述不能为空！"){
         ...
         return false;
      }else if($("#CreatNewPri").val()=="|输入价格"||$("#CreatNewPri").val()=="价格不能为空！"){
  ...
  function showResponse(responseText, statusText)  { 
            $("#DeleteFai-box1 > div").html('提交成功！系统3s后返回');
            window.setTimeout("window.location.href='issue.html'",3000);
            $("#DeleteFai-box1").click(function(){
               $("#DeleteFai-box1").css('display','none');
            });
            return true;
  }
});